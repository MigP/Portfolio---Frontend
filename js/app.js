...
// Document load functions
	$(window).on("load", function() { // Detects device orientation
		if ($(".container").height() > $(".container").width()) { // Portrait
			...
			if (isMobile) {
				viewModel.deviceHeight($(".container").width());
			}
		}

		ko.applyBindings(viewModel); // Applies knockout bindings

		// Make two scrollbars synchronise
			jQuery(function ($) {
			    $(".main_content").on("scroll", function () {
			        $(".main_content").scrollTop($(this).scrollTop());
			    });
			});
		...
		if (page != viewModel.activePage()) { // If clicked page isn't the same as the current page
			...
			// Create new content
				...
				if (page == "home") {
					...
					$(newMainRight).html("<div id='splashright'></div>");
...
// viewModel
	var viewModel = {
		...
		portfolioRightPages: ko.observable(["<div id='activeright'><div style='display: flex;flex-direction: column;'><div data-bind='text: english() ? text.portfolioSummaryEN()[activePageNr()] : text.portfolioSummaryFR()[activePageNr()]' style='padding-block-end: 3em;'></div><div style='display: flex;align-self: center;'><a target='_blank' data-bind='attr: { href: portfolioLiveLinks()[activePageNr()] }, text: english() ? text.livesiteEN() : text.livesiteFR()'></a></div><div style='display: flex;align-self: center;'><a target='_blank' data-bind='visible: portfolioShowCode()[activePageNr()], attr: { href: portfolioCodeLinks()[activePageNr()] }, text: english() ? text.sitecodeEN() : text.sitecodeFR()'></a></div></div></div>"]),
		...
		educationLeftPagesEN: ko.observable(["<p><span class='edTitle'>Deelcertificat (Nederlands – Waystage schriftelijk & mondeling A2)</span><br><span class='edPlace'>CVO Lethas – Huis van het Nederlands, Brussels</span><br><span class='edDate'>NOVEMBER 2018</span><br><span class='edList'>▪ Dutch language course.</span></p><p><span class='edTitle'>Deelcertificat (Nederlands – Breakthrough A1)</span><br><span class='edPlace'>CVO Lethas – Huis van het Nederlands, Brussels</span><br><span class='edDate'>MAY 2018 – JUNE 2018</span><br><span class='edList'>▪ Dutch language course.</span></p><p><span class='edTitle'>Udacity Nanodegree Diploma</span><br><span class='edPlace'>Udacity.com</span><br><span class='edDate'>MARCH 2017 – JULY 2017</span><br><span class='edList'>▪ Front-end web development.</span></p><p><span class='edTitle'>Microsoft Certified Web Design Certificate </span><br><span class='edPlace'>Oxford House Computer Training, London</span><br><span class='edDate'>JANUARY 2001 – JULY 2001</span><br><span class='edList'>▪ Web Design (HTML, CSS, Dreamweaver, Flash, Photoshop).</span></p>"]),
		educationLeftPagesFR: ko.observable(["<p><span class='edTitle'>Deelcertificat (Nederlands – Waystage schriftelijk & mondeling A2)</span><br><span class='edPlace'>CVO Lethas – Huis van het Nederlands, Bruxelles</span><br><span class='edDate'>NOVEMBRE 2018</span><br><span class='edList'>▪ Cours de néerlandais.</span></p><p><span class='edTitle'>Deelcertificat (Nederlands – Breakthrough A1)</span><br><span class='edPlace'>CVO Lethas – Huis van het Nederlands, Bruxelles</span><br><span class='edDate'>MAI 2018 – JUIN 2018</span><br><span class='edList'>▪ Cours de néerlandais.</span></p><p><span class='edTitle'>Udacity Nanodegree Diploma</span><br><span class='edPlace'>Udacity.com</span><br><span class='edDate'>MARS 2017 – JUILLET 2017</span><br><span class='edList'>▪ Développement Web Frontend.</span></p><p><span class='edTitle'>Microsoft Certified Web Design Certificate </span><br><span class='edPlace'>Oxford House Computer Training, Londres</span><br><span class='edDate'>JANVIER 2001 – JUILLET 2001</span><br><span class='edList'>▪ Web Design (HTML, CSS, Dreamweaver, Flash, Photoshop).</span></p>"]),
		educationRightPagesEN: ko.observable(["<p><span class='edTitle'>BSc Software Engineering</span><br><span class='edPlace'>South Bank University (SBU), London</span><br><span class='edDate'>SEPTEMBER 1994 – AUGUST 1998</span><br><span class='edList'>▪ Software engineering.</span></p><p><span class='edTitle'>Computing (first year only)</span><br><span class='edPlace'>Université Libre de Bruxelles (ULB), Brussels</span><br><span class='edDate'>SEPTEMBER 1993 – AUGUST 1994</span><br><span class='edList'>▪ Computing.</span></p><p><span class='edTitle'>European Baccalaureate Certificate (BAC)</span><br><span class='edPlace'>European School, Luxembourg</span><br><span class='edDate'>SEPTEMBER 1987 – JULY 1993</span><br><span class='edList'>▪ Secondary school.</span></p><p><span class='edTitle'>English Language Course Certificate</span><br><span class='edPlace'>St. Hugh’s College, Oxford</span><br><span class='edDate'>AUGUST 1990</span><br><span class='edList'>▪ English language course.</span></p>"]),
		educationRightPagesFR: ko.observable(["<p><span class='edTitle'>BSc Software Engineering</span><br><span class='edPlace'>South Bank University (SBU), Londres</span><br><span class='edDate'>SEPTEMBRE 1994 – AOÛT 1998</span><br><span class='edList'>▪ Software engineering.</span></p><p><span class='edTitle'>Informatique (première année seulement)</span><br><span class='edPlace'>Université Libre de Bruxelles (ULB), Bruxelles</span><br><span class='edDate'>SEPTEMBRE 1993 – AOÛT 1994</span><br><span class='edList'>▪ Informatique.</span></p><p><span class='edTitle'>Certificat de baccalauréat européen (BAC)</span><br><span class='edPlace'>École Européenne, Luxembourg</span><br><span class='edDate'>SEPTEMBRE 1987 – JUILLET 1993</span><br><span class='edList'>▪ École secondaire.</span></p><p><span class='edTitle'>English Language Course Certificate</span><br><span class='edPlace'>St. Hugh’s College, Oxford</span><br><span class='edDate'>AOÛT 1990</span><br><span class='edList'>▪ Cours d’anglais.</span></p>"]),

		workLeftPagesEN: ko.observable(["<p><span class='workTitle'>Technical assistant</span><br><span class='workPlace'>REPER – Portuguese Permanent Representation to the European Union, Brussels</span><br><span class='workDate'>SEPTEMBER 2019 – JULY 2021</span><br><span class='workList'>▪ Encryption and IT.</span><br><span class='workList'>▪ Creation and editing of online and intranet content during the period of the Portuguese Presidency of the EU.</span><br><span class='workList'>▪ Communications encryption.</span></p><p><span class='workTitle'>Graphic/Web design and  digital media (volonteer)</span><br><span class='workPlace'>ERIO (European Roma Information Office), Brussels</span><br><span class='workDate'>SEPTEMBER 2012 – AUGUST 2019</span><br><span class='workList'>▪ Provided web and graphic design for various projects and the company’s own web page.</span><br><span class='workList'>▪ Created and edited digital media content for various projects, such as video documentaries and awareness campaigns.</span></p>"]),
		workLeftPagesFR: ko.observable(["<p><span class='workTitle'>Assistant technique</span><br><span class='workPlace'>REPER – Représentation Permanente du Portugal auprès de l’Union Européene, Bruxelles</span><br><span class='workDate'>SEPTEMBRE 2019 – JUILLET 2021</span><br><span class='workList'>▪ Chiffrement et informatique.</span><br><span class='workList'>▪ Création et édition de contenu online et intranet pendant la période de la présidence Portugaise de l’UE.</span><br><span class='workList'>▪ Chiffrement de communications.</span></p><p><span class='workTitle'>Graphisme / Web design et medias numériques (volontaire)</span><br><span class='workPlace'>ERIO (European Roma Information Office), Bruxelles</span><br><span class='workDate'>SEPTEMBRE 2012 – AOÛT 2019</span><br><span class='workList'>▪ Conception web et graphique pour divers projets et la page web de l’organisation.</span><br><span class='workList'>▪ Création et édition de contenu multimédia numérique pour divers projets, tels que des documentaires vidéo et des campagnes de sensibilisation.</span></p>"]),
		workRightPagesEN: ko.observable(["<p><span class='workTitle'>Database maintenance and general secretarial work</span><br><span class='workPlace'>Awesome Interiors, London</span><br><span class='workDate'>NOVEMBER 1998 – APRIL 2001</span><br><span class='workList'>▪ Maintained and updated the company’s databases with products, clients, and sales.</span></p><p><span class='workTitle'>Freelance data entry (with some basic translation)</span><br><span class='workPlace'>European Parliament, Luxembourg</span><br><span class='workDate'>DECEMBER 1992 – DECEMBER 1994</span><br><span class='workList'>▪ Added specialised data to terminology databases in French, English, and Portuguese, and verified whether the correct translations were used.</span></p>"]),
		workRightPagesFR: ko.observable(["<p><span class='workTitle'>Maintien de la base de données et secrétariat général</span><br><span class='workPlace'>Awesome Interiors, Londres</span><br><span class='workDate'>NOVEMBRE 1998 – AVRIL 2001</span><br><span class='workList'>▪ Maintien et mise à jour des bases de données de l’entreprise avec les produits, les clients, et les ventes.</span></p><p><span class='workTitle'>Entrée de données avec quelques traductions de base (Freelance)</span><br><span class='workPlace'>Parlement Européen, Luxembourg</span><br><span class='workDate'>DÉCEMBRE 1992 – DÉCEMBRE 1994</span><br><span class='workList'>▪ Entrée de données spécialisés aux bases de données terminologiques en français, anglais et portugais et vérification de l’utilisation des traductions correctes.</span></p>"]),
		...
		aboutLargeImgs: ko.observable(['images/pic_large.png']),
		aboutSmallImgs: ko.observable(['images/pic_small.png']),	
		...
		bigRightFlip: function(newElement) {
			if (this.activePage() == "portfolio") {
				...
				$(newElement).html("<div id='alert_message'><p data-bind='text: english() ? viewModel.alertMessagesEN()[viewModel.activeAlertMessage()] : viewModel.alertMessagesFR()[viewModel.activeAlertMessage()]'></p></div>");
				ko.applyBindings(viewModel, $("#alert_message")[0]);
			}
		},
		...
		longRightFlip: function(newElement) {
			if (this.activePage() == "portfolio") {
				...
				$(newElement).html("<div id='downloadCv1' style='display: flex;align-self: center;'><a class='workList' target='_blank' data-bind=\"attr: { href: english() ? 'docs/CV-En.pdf' : 'docs/CV-Fr.pdf' }, text: english() ? 'Download my CV' : 'Téléchargez mon CV'\"></a></div>");
				ko.applyBindings(viewModel, $("#downloadCv1")[0]);
			} else if (this.activePage() == "work") {
				$(newElement).html("<div id='downloadCv2' style='display: flex;align-self: center;'><a class='workList' target='_blank' data-bind=\"attr: { href: english() ? 'docs/CV-En.pdf' : 'docs/CV-Fr.pdf' }, text: english() ? 'Download my CV' : 'Téléchargez mon CV'\"></a></div>");
				ko.applyBindings(viewModel, $("#downloadCv2")[0]);
			} else if (this.activePage() == "about") {
				$(newElement).html("<div id='downloadCv3' style='display: flex;align-self: center;'><a class='workList' target='_blank' data-bind=\"attr: { href: english() ? 'docs/CV-En.pdf' : 'docs/CV-Fr.pdf' }, text: english() ? 'Download my CV' : 'Téléchargez mon CV'\"></a></div>");
				ko.applyBindings(viewModel, $("#downloadCv3")[0]);
			} else if (this.activePage() == "contact") {
				$(newElement).html("<div id='downloadCv4' style='display: flex;align-self: center;'><a class='workList' target='_blank' data-bind=\"attr: { href: english() ? 'docs/CV-En.pdf' : 'docs/CV-Fr.pdf' }, text: english() ? 'Download my CV' : 'Téléchargez mon CV'\"></a></div>");
