		...
		if (page != viewModel.activePage()) { // If clicked page isn't the same as the current page
			...
			// Create new content
				...
				if (page == "home") {
					...
					$(newMainRight).html("<div id='mainCode' class='this_code_link' data-bind='text: english() ? text.mainCodeEN() : text.mainCodeFR()' onclick='window.open(\"https://github.com/MigP/Portfolio\");'></div><div id='splashright'></div>");
...
// viewModel
	var viewModel = {
		...
		portfolioRightPages: ko.observable(["<div id='activeright'><div style='display: flex;flex-direction: column;'><div class='port_sum' data-bind='text: english() ? text.portfolioSummaryEN()[activePageNr()] : text.portfolioSummaryFR()[activePageNr()]'></div><div class='port_links' data-bind='text: english() ? text.livesiteEN() : text.livesiteFR()' onclick='window.open(viewModel.portfolioLiveLinks()[viewModel.activePageNr()]);'></div><div class='port_links' data-bind='visible: portfolioShowCode()[activePageNr()], text: english() ? text.sitecodeEN() : text.sitecodeFR()' onclick='window.open(viewModel.portfolioCodeLinks()[viewModel.activePageNr()]);'></div></div></div>"]),
		...
		educationLeftPagesEN: ko.observable(["<p><span class='edTitle'>In progress...</span><br><span class='edPlace'>Bruxelles Formation, Brussels</span><span class='edDate'>MAY 22 - OCT 22</span><br><span class='edList'>▪ Vocational training in Android development.</span></p><p><span class='edTitle'>Deelcertificat (A1 & A2)</span><br><span class='edPlace'>CVO Lethas – Huis v.h. Nederlands, Brussels</span><span class='edDate'>MAY 18 - NOV 18</span><br><span class='edList'>▪ Dutch language course.</span></p><p><span class='edTitle'>Udacity Nanodegree Diploma</span><br><span class='edPlace'>Udacity.com</span><span class='edDate'>MAR 17 – JUL 17</span><br><span class='edList'>▪ Front-end web development.</span></p><p><span class='edTitle'>Microsoft Certified Web Design Certificate </span><br><span class='edPlace'>Oxford House Computer Training, London</span><span class='edDate'>JAN 01 – JUL 01</span><br><span class='edList'>▪ Web Design (HTML, CSS, Dreamweaver, Flash, Photoshop).</span></p>"]),
		educationLeftPagesFR: ko.observable(["<p><span class='edTitle'>En cours...</span><br><span class='edPlace'>Bruxelles Formation, Bruxelles</span><span class='edDate'>MAI 22 - OCT 22</span><br><span class='edList'>▪ Formation professionnelle en Développement Android.</span></p><p><span class='edTitle'>Deelcertificat (A1 & A2)</span><br><span class='edPlace'>CVO Lethas – Huis v.h. Nederlands, Bruxelles</span><span class='edDate'>MAI 18 - NOV 18</span><br><span class='edList'>▪ Cours de néerlandais.</span></p><p><span class='edTitle'>Udacity Nanodegree Diploma</span><br><span class='edPlace'>Udacity.com</span><span class='edDate'>MAR 17 – JUIL 17</span><br><span class='edList'>▪ Développement Web Frontend.</span></p><p><span class='edTitle'>Microsoft Certified Web Design Certificate </span><br><span class='edPlace'>Oxford House Computer Training, Londres</span><span class='edDate'>JAN 01 – JUIL 01</span><br><span class='edList'>▪ Web Design (HTML, CSS, Dreamweaver, Flash, Photoshop).</span></p>"]),
		educationRightPagesEN: ko.observable(["<p><span class='edTitle'>BSc Software Engineering</span><br><span class='edPlace'>South Bank University (SBU), London</span><span class='edDate'>SEP 94 – AUG 98</span><br><span class='edList'>▪ Software engineering.</span></p><p><span class='edTitle'>Computing (first year only)</span><br><span class='edPlace'>Université Libre de Bruxelles (ULB), Brussels</span><span class='edDate'>SEP 93 – AUG 94</span><br><span class='edList'>▪ Computing.</span></p><p><span class='edTitle'>European Baccalaureate Certificate (BAC)</span><br><span class='edPlace'>European School, Luxembourg</span><span class='edDate'>SEP 87 – JUL 93</span><br><span class='edList'>▪ Secondary school.</span></p>"]),
		educationRightPagesFR: ko.observable(["<p><span class='edTitle'>BSc Software Engineering</span><br><span class='edPlace'>South Bank University (SBU), Londres</span><span class='edDate'>SEP 94 – AOÛ 98</span><br><span class='edList'>▪ Software engineering.</span></p><p><span class='edTitle'>Informatique (première année seulement)</span><br><span class='edPlace'>Université Libre de Bruxelles (ULB), Bruxelles</span><span class='edDate'>SEP 93 – AOÛ 94</span><br><span class='edList'>▪ Informatique.</span></p><p><span class='edTitle'>Certificat de baccalauréat européen (BAC)</span><br><span class='edPlace'>École Européenne, Luxembourg</span><span class='edDate'>SEP 87 – JUIL 93</span><br><span class='edList'>▪ École secondaire.</span></p>"]),
		...
		aboutRightPagesEN: ko.observable(["My interest in software started back in the mid 80s when I was gifted my very first computer - a Timex Sinclair 2068 with its astounding 48Kb RAM and 24Kb ROM. I soon began altering simple game features using Basic.<br><br>\"Born in Porto, raised in Luxembourg, matured in London, and settled in Brussels\" would perhaps be the one-liner that sums up the experiences that most deeply shaped my life. They instilled in me a deeply ingrained love for travel, languages, and flourishing outside my comfort zone."]),
		aboutRightPagesFR: ko.observable(["Mon intérêt pour les logiciels a commencé au milieu des années 80 lorsque j'ai reçu mon tout premier ordinateur - un Timex Sinclair 2068 avec ses incroyables 48Kb RAM et 24Kb ROM. J'ai rapidement commencé à modifier des fonctionnalités de jeu simples à l'aide de Basic.<br><br>\"Né à Porto, élevé à Luxembourg, mûri à Londres et installé à Bruxelles\" serait peut-être le slogan qui résume les expériences qui ont le plus marqué ma vie. Elles m'ont inculqué un amour profondément enraciné pour les voyages, les langues et l'épanouissement en dehors de ma zone de confort."]),
